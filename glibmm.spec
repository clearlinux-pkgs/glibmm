...
Source0  : https://download.gnome.org/sources/glibmm/2.74/glibmm-2.74.0.tar.xz
...
%prep
%setup -q -n glibmm-2.74.0
cd %{_builddir}/glibmm-2.74.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663613021
