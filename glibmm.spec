...
Source0  : https://download.gnome.org/sources/glibmm/2.68/glibmm-2.68.1.tar.xz
...
%prep
%setup -q -n glibmm-2.68.1
cd %{_builddir}/glibmm-2.68.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621555223
...
cp %{_builddir}/glibmm-2.68.1/COPYING %{buildroot}/usr/share/package-licenses/glibmm/10b7ed0f3f2cfe72fe0c64c167033cbbf8e62d93
cp %{_builddir}/glibmm-2.68.1/COPYING.tools %{buildroot}/usr/share/package-licenses/glibmm/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
