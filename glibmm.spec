...
Source0  : https://download.gnome.org/sources/glibmm/2.72/glibmm-2.72.0.tar.xz
...
%prep
%setup -q -n glibmm-2.72.0
cd %{_builddir}/glibmm-2.72.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649450529
...
cp %{_builddir}/glibmm-2.72.0/COPYING %{buildroot}/usr/share/package-licenses/glibmm/10b7ed0f3f2cfe72fe0c64c167033cbbf8e62d93
cp %{_builddir}/glibmm-2.72.0/COPYING.tools %{buildroot}/usr/share/package-licenses/glibmm/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
