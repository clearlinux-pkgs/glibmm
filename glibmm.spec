...
Source0  : https://download.gnome.org/sources/glibmm/2.82/glibmm-2.82.0.tar.xz
...
%prep
%setup -q -n glibmm-2.82.0
cd %{_builddir}/glibmm-2.82.0
pushd ..
cp -a glibmm-2.82.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724766072
