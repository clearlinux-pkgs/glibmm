...
Source0  : https://download.gnome.org/sources/glibmm/2.78/glibmm-2.78.1.tar.xz
...
%prep
%setup -q -n glibmm-2.78.1
cd %{_builddir}/glibmm-2.78.1
pushd ..
cp -a glibmm-2.78.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706887646
